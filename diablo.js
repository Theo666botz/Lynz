...
global.ownerName = 'Lynzz'
global.ownerNumber = ["6281911317205@s.whatsapp.net"]
global.packname = 'Lynzz_'
...
° Device  : ᴍᴜʟᴛɪ ᴅᴇᴠɪᴄᴇ
 ▰▱▰▱▰▱▰▱▰▱▰▱▰▱
Follow Ig @rijalsavior
https://sociabuzz.com/bot_wa
...
case 'kntl':
jiren = ` 
ucapan nya dek di jaga jangan asal cocote
...
⭔ Url : ${anu.url}`,
            ...
            break
case 'sc':
diablobotwhatsapp.reply('Harga Sc Botz > 5k noenc ')
break
case 'bot':
...
case 'menfess':
			...
			case 'confess':
				...
				if (pesan.length < 1) return diablobotwhatsapp.reply(`Harus di isi semua! ex : menfess 62831xxxxxxxx|orang|hallo kamu`)
				 let teksnya = `Assalamualaikum kak ada Menfess nih!!\n─────────────\n©® https://instagram.com/rijalsavior?igshid=ZDdkNTZiNTM=\n─────────────\n\nDari : _${saking}_ \nPesan : _${pesan}_ `
				header = 'hayyy'
					gambar = `https://telegra.ph/file/5ed9cc78b8719dd5c2a06.jpg`

				 but = [
					{ urlButton: { displayText: `Follow IG`, url : `https://instagram.com/rijalsavior?igshid=ZDdkNTZiNTM=` } },
